...
Not the drawing engine (that is arkitect/lib/, which may not know which city it is drawing for)
...
Nothing here may import a project. arkitect/lib/verify/test_neutrality.py enforces it.
"""
