...
resolves to the canvas of the document THIS THREAD is drawing (arkitect/lib/draw/context.py), so
...
from arkitect.lib.draw.page import DA, GREY, LAY, canvas_proxy
