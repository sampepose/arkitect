...
package (codes/columbus), never in it.

A table here is ONE transcription with ONE test pinning it (codes/verify). Projects import
it; they never carry a copy. Move a project's copy here only when lib/verify/twins.py
