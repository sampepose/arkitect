...
codes/verify/test_bracing_tables.py. It lived word for word in each project's bracing model
until 2026-09-18.
...
# against the 2018 IRC print, and pinned by lib/verify/test_bracing.py. Seismic Design
