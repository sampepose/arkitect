...
One transcription for every project, pinned by arkitect/codes/verify/test_fire_separation.py. Where
...
# Transcribed from the table, not from a summary, and pinned by arkitect/lib/verify/test_fsd.py.
