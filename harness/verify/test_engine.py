"""harness/engine.py writes the one-line .pth that makes the engine importable elsewhere."""
import os
import shutil
import subprocess
import sys
...
class LinkTests(unittest.TestCase):
    ...
    def test_python_reads_the_line_as_a_path(self):
        ...
        code = 'import site, sys; site.addsitedir(%r); import lib; print(lib.__file__)' % self.site
