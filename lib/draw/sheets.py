...
from lib.model.mirror import (mrooms, mpoly, mdoors, mwins, mops, mdims, mnotes,
                              mtags, mchains, mfurn)
...
# lib/export/dxf.py and lib/verify/trace.py monkeypatch sheets.PlanDraw.__init__ and
# sheets.Sheet.__init__ by that path. Do not drop them even if unused here.
from lib.draw.page import DA, GREY, LAY, LGREY, POCHE, PlanDraw, Sheet
from lib.model.regrid import PARTITION, PART_STUD
from lib.model.records import Geometry
from lib.model.dimensions import (regrid_all, net_areas, wall_faces, room_dims,
