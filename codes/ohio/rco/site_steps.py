...
A project hands these its own steps, bands and stairs (lib/model/grade.py's records) and the
height it holds a stoop's foot at where no band grades it.
"""
from lib.units import IN, inches
from lib.model.grade import LANDING_MAX, TOL, edge_points, grade_at, top_at
