...
A project hands every function its drainage building `b` (lib/model/drains.py) and ONE
...
from lib.model.runs import (TOL, along as _along, crossing as _crossing, in_rect as _inside, length as _len,
                            points as _points, seg_rect_dist as _seg_rect_dist)
from lib.model.drains import _to_site
from lib.model.pipe import od
from codes.ohio.opc_drainage import SIZE_IN, invert_at
...
# These last four are read only by codes/ohio/opc_service_entry.py, which needs the
