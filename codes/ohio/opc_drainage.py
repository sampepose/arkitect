...
One transcription for every project, pinned by codes/verify/test_drainage_tables.py. The
rows are the ones a dwelling uses; a project with another fixture adds its row HERE.
"""
from lib.units import IN
from lib.model.runs import along, length, same_point
from lib.model.drains import exit_run, feeds, receiver, run_serves, stack_by_name

# ================================ the tables ================================
# Table 709.1, DRAINAGE FIXTURE UNITS FOR FIXTURES AND GROUPS: the rows this project
# has. Transcribed from the table's text and pinned by codes/verify/test_drainage_tables.py;
