...
class MechanicalRuleTests(unittest.TestCase):
    ...
    def test_m1505_4_3_1_rows(self):
        ...
        from arkitect.codes.ohio.rco.mechanical import whole_house_cfm
    ...
    def test_route_length_and_elbows(self):
        from arkitect.codes.ohio.rco.mechanical import DRYER_ELBOW, dryer_equivalent, route_length
    ...
    def test_the_gap_is_along_the_wall_from_the_caps_opening(self):
        from arkitect.codes.ohio.rco.mechanical import CAP_R, odu_gap
