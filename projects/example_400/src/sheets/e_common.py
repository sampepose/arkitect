...
NOTES = [
    ...
    "10. FEEDERS — UNIT FEEDERS PER NEC 310.12, THE SERVICE-ENTRANCE CONDUCTORS PER TABLE 310.16. EVERY FEEDER FROM THE METERING IS 4-WIRE WITH AN EQUIPMENT GROUNDING CONDUCTOR PER TABLE 250.122; THE BONDING JUMPER IS AT THE SERVICE DISCONNECT ONLY. GROUNDING ELECTRODE PER THE ONE-LINE.",
