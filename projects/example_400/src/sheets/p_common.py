...
NOTES = [
    ...
    "9.  HOT WATER — TUB AND SHOWER VALVES PRESSURE-BALANCING OR THERMOSTATIC, LIMITED TO 120 F, OPC 424.3. HOT-WATER PIPING INSULATED TO R-3 WHERE RCO 1103.5.3 REQUIRES IT: EVERY 3/4\" LINE, THE HEATER-TO-MANIFOLD LINES AND THE RUNS TO THE KITCHENS.",
    "10. WATER HAMMER — ARRESTERS TO ASSE 1010 AT EACH CLOTHES WASHER AND DISHWASHER, OPC 604.9.",
