"""codes/columbus/zoning_sheets.py and lib/buildkit.py: the two day-one sheets build for an
interior lot and a corner lot, check the model before drawing, and print no string on
another (lib/verify/sheet_text.py's overlap rule, read through a recording canvas)."""
import os
import tempfile
import unittest
...
from codes.columbus.zoning_sheets import cover_sheet, zoning_rows, zoning_site_plan
from harness import intake as I
