...
It lives here rather than in arkitect/lib/draw because every label on it names a section -- OPC 305.4
for the freezing the insulation outboard of the pipe prevents, RCO 602.6.1 for the plate a
bored hole weakens, RCO 302.4 where the wall is rated -- and arkitect/lib/ is code-neutral
(arkitect/lib/verify/test_neutrality.py).
...
arkitect/lib/model/fit.py's cavity_violations() is the check; this is the drawing it answers to.
"""
