...
NOTES = [
    ...
    "11. FEEDERS — AS THE ONE-LINE SIZES THEM: UNIT FEEDERS PER NEC 310.12, NOT UNDER 100 A AMPACITY, 220.82(A); THE HOUSE FEEDERS AND THE SERVICE-ENTRANCE CONDUCTORS PER TABLE 310.16. EVERY FEEDER FROM THE BANK IS 4-WIRE WITH AN EQUIPMENT GROUNDING CONDUCTOR PER TABLE 250.122; THE BONDING JUMPER IS AT THE SERVICE DISCONNECT ONLY. GROUNDING ELECTRODE PER THE ONE-LINE.",
