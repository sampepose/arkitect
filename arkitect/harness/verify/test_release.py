"""arkitect/harness/release.py on a scratch repository: what is withheld, what ships, what the public
overlay replaces, and that the snapshot is a fresh repository of one commit. (Running the
whole suite inside a snapshot is `python3 -m arkitect.harness.release check`; it is not run from here,
...
class ReleaseTests(unittest.TestCase):
    ...
    def test_the_split(self):
        ...
        self.assertEqual(sorted(ship), ['arkitect/lib/a.py', 'projects/example_1/build.py'])
    ...
    def test_the_snapshot_is_the_engine_the_overlay_and_one_fresh_commit(self):
        ...
        self.assertEqual(written, ['README.md', 'arkitect/lib/a.py', 'decisions/README.md',
