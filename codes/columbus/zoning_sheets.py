...
Both print codes/columbus/fit.py's rows, which is why they are here and not in lib/: every
...
projects' did). Until then they are the set, and harness/progress.py lists them as drawn, not done.
"""
from reportlab.lib.colors import Color, black
from reportlab.lib.units import inch
from reportlab.pdfbase import pdfmetrics

from codes import columbus as JUR
