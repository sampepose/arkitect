...
transcription for every project, pinned by arkitect/codes/verify/test_water_supply.py.
...
# arkitect/lib/verify/test_plumbing.py; never retype them from a summary.
WSFU = {
